...
const securityHeaders = [
  ...
  // but blocks third-party script injection, object/embed and frame ancestors.
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://assets.calendly.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://assets.calendly.com",
      "img-src 'self' data: blob: https:",
      "media-src 'self' https://res.cloudinary.com blob:",
      "font-src 'self' data: https://fonts.gstatic.com",
      "frame-src 'self' https://api.razorpay.com https://checkout.razorpay.com https://calendly.com",
      "connect-src 'self' https://*.vercel-insights.com https://*.upstash.io https://*.kv.vercel-storage.com https://api.cloudinary.com https://api.razorpay.com https://lumberjack.razorpay.com https://calendly.com https://*.calendly.com",
