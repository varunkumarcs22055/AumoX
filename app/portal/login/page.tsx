      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-ink-300 font-light">
            Track your project's progress, phase by phase.
          </p>
        </div>
        ...
        <form onSubmit={onSubmit} className="card p-8 gold-border space-y-5">
          ...
          <p className="text-xs text-ink-400 font-light text-center pt-2">
            Credentials are provided by your AUMOXO project lead.
            <br />
            Need access? Email{" "}
            <a href="mailto:hello@aumoxo.tech" className="text-gold-300 hover:text-gold-200">
              hello@aumoxo.tech
            </a>
          </p>
        </form>
