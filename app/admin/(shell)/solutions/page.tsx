...
const STARTER_PROJECTS: Array<Partial<Solution>> = [
  {
    ...
    description: "",
    problem: "Modern engineering teams are distributed, but writing and reviewing code together still means juggling a separate editor, chat and call — so pairing is clunky, reviews lag and context gets lost between tools.",
    approach: "CollabCode brings the whole workflow into one real-time workspace: multiple developers edit and review the same codebase live, with AI-assisted development workflows that speed up writing and reviewing — built on a modern, scalable SaaS architecture and deployed to the cloud.",
    outcome: "A faster, more connected way to build software — improving developer productivity and streamlining collaborative development through real-time collaboration and AI assistance.",
  ...
  },
  {
    ...
    description: "",
    problem: "Aurea, a fine-dining restaurant, needed a digital presence as refined as its cuisine — one that conveys atmosphere, showcases the seasonal menu and lets guests reserve a table effortlessly on any device.",
    approach: "We designed and built a polished, fully responsive site: a cinematic hero, an 'Our Story' chef feature, a categorised menu (starters, mains, desserts, drinks) with pricing, a gallery, guest reviews and a clear 'Reserve a Table' flow — all crafted to feel premium and load fast.",
    outcome: "A sophisticated online storefront that mirrors the in-restaurant experience and turns visitors into reservations.",
